...
public final class OpenSSLECGroupContext {
    ...
    OpenSSLECGroupContext(NativeRef.EC_GROUP groupCtx2) {
        this.groupCtx = groupCtx2;
    }
    ...
    static OpenSSLECGroupContext getCurveByName(String curveName) {
        ...
        return new OpenSSLECGroupContext(new NativeRef.EC_GROUP(ctx));
    }
    ...
    static OpenSSLECGroupContext getInstance(ECParameterSpec params) throws InvalidAlgorithmParameterException {
        ...
        if (field instanceof ECFieldFp) {
            ...
            switch (p.bitLength()) {
                ...
                case PSKKeyManager.MAX_KEY_LENGTH_BYTES /*{ENCODED_INT: 256}*/:
                ...
                case AndroidBinXmlParser.Chunk.RES_XML_TYPE_RESOURCE_MAP:
            ...
            try {
                ...
                if (group != 0) {
                    return new OpenSSLECGroupContext(new NativeRef.EC_GROUP(group));
                }
                throw new InvalidAlgorithmParameterException("EC_GROUP_new_arbitrary returned NULL");
            } catch (Throwable exception) {
                throw new InvalidAlgorithmParameterException("EC_GROUP_new_arbitrary failed", exception);
            }
        } else {
