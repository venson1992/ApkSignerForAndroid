...
final class EvpMdRef {
    ...
    static String getJcaDigestAlgorithmStandardName(String algorithm) {
        ...
        if ("SHA-256".equals(algorithmUpper) || OidConstants.OID_DIGEST_SHA256.equals(algorithmUpper)) {
            return "SHA-256";
        }
        if ("SHA-512".equals(algorithmUpper) || OidConstants.OID_DIGEST_SHA512.equals(algorithmUpper)) {
            return "SHA-512";
        }
        if ("SHA-1".equals(algorithmUpper) || OidConstants.OID_DIGEST_SHA1.equals(algorithmUpper)) {
            return "SHA-1";
        }
        if ("SHA-384".equals(algorithmUpper) || OidConstants.OID_DIGEST_SHA384.equals(algorithmUpper)) {
            return "SHA-384";
        }
        if ("SHA-224".equals(algorithmUpper) || OidConstants.OID_DIGEST_SHA224.equals(algorithmUpper)) {
            return "SHA-224";
        }
        return null;
    }
