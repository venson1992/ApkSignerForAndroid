...
public final class NativeCrypto {
    ...
    static final Set<String> SUPPORTED_TLS_1_2_CIPHER_SUITES_SET = new HashSet();
    ...
    static final Set<String> SUPPORTED_TLS_1_3_CIPHER_SUITES_SET = new HashSet(Arrays.asList(SUPPORTED_TLS_1_3_CIPHER_SUITES));
    ...
    static final String[] TLSV13_PROTOCOLS = {SUPPORTED_PROTOCOL_TLSV1, SUPPORTED_PROTOCOL_TLSV1_1, SUPPORTED_PROTOCOL_TLSV1_2, SUPPORTED_PROTOCOL_TLSV1_3};
    ...
    static native void ENGINE_SSL_force_read(long j, NativeSsl nativeSsl, SSLHandshakeCallbacks sSLHandshakeCallbacks) throws IOException;
    ...
    static native int EVP_AEAD_CTX_open(long j, byte[] bArr, int i, byte[] bArr2, int i2, byte[] bArr3, byte[] bArr4, int i3, int i4, byte[] bArr5) throws ShortBufferException, BadPaddingException, IndexOutOfBoundsException;

    static native int EVP_AEAD_CTX_seal(long j, byte[] bArr, int i, byte[] bArr2, int i2, byte[] bArr3, byte[] bArr4, int i3, int i4, byte[] bArr5) throws ShortBufferException, BadPaddingException, IndexOutOfBoundsException;
    ...
    static native byte[] SSL_export_keying_material(long j, NativeSsl nativeSsl, byte[] bArr, byte[] bArr2, int i) throws SSLException;
    ...
    static native void X509_CRL_verify(long j, OpenSSLX509CRL openSSLX509CRL, NativeRef.EVP_PKEY evp_pkey) throws BadPaddingException, SignatureException, NoSuchAlgorithmException, InvalidKeyException, IllegalBlockSizeException;
    ...
    static native void setHasApplicationProtocolSelector(long j, NativeSsl nativeSsl, boolean z) throws IOException;
    ...
    static {
        ...
        if (loadError == null) {
            ...
            HAS_AES_HARDWARE = HAS_AES_HARDWARE;
    ...
    public static class Range {
        ...
        public Range(String min2, String max2) {
            this.min = min2;
            this.max = max2;
        }
    }
    ...
    static void setEnabledProtocols(long ssl, NativeSsl ssl_holder, String[] protocols) {
        ...
        SSL_set_protocol_versions(ssl, ssl_holder, getProtocolConstant(range.min), getProtocolConstant(range.max));
    }
    ...
    private static int getProtocolConstant(String protocol) {
        ...
        if (protocol.equals(SUPPORTED_PROTOCOL_TLSV1_3)) {
            return 772;
        }
    ...
    static String[] checkEnabledProtocols(String[] protocols) {
        ...
        for (String protocol : protocols) {
            ...
            } else if (!protocol.equals(SUPPORTED_PROTOCOL_TLSV1) && !protocol.equals(SUPPORTED_PROTOCOL_TLSV1_1) && !protocol.equals(SUPPORTED_PROTOCOL_TLSV1_2) && !protocol.equals(SUPPORTED_PROTOCOL_TLSV1_3) && !protocol.equals(OBSOLETE_PROTOCOL_SSLV3)) {
    ...
    static void setEnabledCipherSuites(long ssl, NativeSsl ssl_holder, String[] cipherSuites, String[] protocols) {
        ...
        for (String cipherSuite : cipherSuites) {
            if (!cipherSuite.equals(TLS_EMPTY_RENEGOTIATION_INFO_SCSV)) {
                if (!cipherSuite.equals(TLS_FALLBACK_SCSV) || (!maxProtocol.equals(SUPPORTED_PROTOCOL_TLSV1) && !maxProtocol.equals(SUPPORTED_PROTOCOL_TLSV1_1))) {
    ...
    static String[] checkEnabledCipherSuites(String[] cipherSuites) {
        ...
        for (int i = 0; i < cipherSuites.length; i++) {
            ...
            } else if (!cipherSuites[i].equals(TLS_EMPTY_RENEGOTIATION_INFO_SCSV) && !cipherSuites[i].equals(TLS_FALLBACK_SCSV) && !SUPPORTED_TLS_1_2_CIPHER_SUITES_SET.contains(cipherSuites[i]) && !SUPPORTED_LEGACY_CIPHER_SUITES_SET.contains(cipherSuites[i])) {
