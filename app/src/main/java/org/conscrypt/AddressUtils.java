...
public final class AddressUtils {
    ...
    static boolean isValidSniHostname(String sniHostname) {
        ...
        if ((sniHostname.equalsIgnoreCase("localhost") || sniHostname.indexOf(46) != -1) && !isLiteralIpAddress(sniHostname) && !sniHostname.endsWith(".") && sniHostname.indexOf(0) == -1) {
            return true;
        }
        return false;
    }
    ...
    static boolean isLiteralIpAddress(String hostname) {
        ...
        if (ipPattern2 == null) {
            ipPattern2 = Pattern.compile(IP_PATTERN);
            ipPattern = ipPattern2;
        }
