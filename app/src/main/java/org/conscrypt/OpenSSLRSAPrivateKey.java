...
public class OpenSSLRSAPrivateKey implements RSAPrivateKey, OpenSSLKeyHolder {
    ...
    static OpenSSLKey wrapPlatformKey(RSAPrivateKey rsaPrivateKey) throws InvalidKeyException {
        ...
        return wrapper != null ? wrapper : new OpenSSLKey(NativeCrypto.getRSAPrivateKeyWrapper(rsaPrivateKey, rsaPrivateKey.getModulus().toByteArray()), true);
    }
    ...
    public void readParams(byte[][] params) {
        ...
        } else if (params[2] != null || this.key.isHardwareBacked()) {
